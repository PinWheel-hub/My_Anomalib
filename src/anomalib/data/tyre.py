...
CATEGORIES = (
    "JD2023-GuoChan",
    "JD2023-GuoChan_side",
    "650R16-12PR-CR926-1614",
    "12R225-18PR-AZ189-1614",
    "700R16-8PR-EZ525-1614",
)


def make_tyre_dataset(
...
class TyreDataset(AnomalibDataset):
    """MVTec dataset class.
    ...
    def _setup(self) -> None:
        self.samples = make_tyre_dataset(self.root_category, split=self.split, extensions=IMG_EXTENSIONS)


class Tyre(AnomalibDataModule):
    """MVTec Datamodule.
